...
Strings_8a483:
	...
	db   "Tausche KARTEN via";"ともだちと　じぶん<NO>めいしを"
	next "IR mit Freunden.@";"せきがいせんで　こうかん　します@"
...
MenuHeader_0x8a9f2:
	db MENU_BACKUP_TILES ; flags
	menu_coords 8, 4, 18, TEXTBOX_Y - 1
	dw MenuData_0x8a9fa
	db 1 ; default option
...
String_8aaf0:
	db   "Die KARTE wurde";"あたらしい　めいし<PKMN>できまし<LF>@"
	next "aktualisiert.@"
...
String_8ac3b:
	db   "Diesen Freund";"こ<NO>ともだち<NI>でんわを"
	next "anrufen?@";"かけますか？@"*
...
String_AskOverwriteCard:
	db   "Diese KARTE";"こ<NO>めいし<WO>けして"
	next "ersetzen?@";"いれかえますか？@"
