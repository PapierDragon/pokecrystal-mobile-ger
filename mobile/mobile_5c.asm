...
String_171aa7:
	db   "Verbinde mit dem";"モバイルアダプタに"
	next "MOBILEN ADAPTER…";"せつぞく　しています"
	;next "しばらく　おまちください"
	db   "@"
...
String_171c73:
	db   "MOBILES CENTER";"モバイルセンターを　けってい"
...
String_172e3f:
	db "UMSCH ZUR. O.K.@";"きりかえ　やめる　　けってい@"
String_172e4e:
	db "UMSCH ZUR. O.K.@";"きりかえ　やめる　　"
String_172e58:
	db "O.K.@";"けってい@"
String_172e5d:
	db   "Wähle MOBILES";"せつぞくする　モバイルセンターを"
