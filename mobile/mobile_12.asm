...
.asm_481ce
	...
	jr nz, .asm_481db
	lb bc, 2, 8
	hlcoord 11, 8 ; prefecture position
	call ClearBox
.asm_481db
	bit 3, d
	jr nz, .asm_481f1
...
MobileString_Address:        db "Wohnort@"
...
MobileDesc_Address:          db "Dein Wohnort?@"
...
Prefectures: ; Some names shortened to fit, check for official initials later.
	...
	db "AT-1@"      ; Burgenland
	db "AT-2@"      ; Carinthia
	db "AT-3@"      ; Lower Austria
	db "AT-4@"      ; Upper Austria
	db "AT-5@"      ; Salzburg
	db "AT-6@"      ; Styria
	db "AT-7@"      ; Tyrol
	db "AT-8@"      ; Vorarlberg
...
TellNowTellLaterMenu:
	...
	ld a, $b ; Y Placement of 'Tell Now' 'Tell Later' Cursor
