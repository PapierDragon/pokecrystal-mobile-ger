...
String_102fdb:
	db   "Mit den #MON"		; "あいてがわ<NO>せんたくに"
	next "deines Freundes"			; "いじょう<PKMN>あるようです！！"
	cont "stimmt was nicht!"
	done
...
String_103002:
	db   "Ein #MON deines"	; "その#を　こうかんすると"
	next "Freundes scheint"		; "せんとう　できなく　なっちゃうよ！"
...
String_10302e:
	db   "Dein Freund hat"		; "あいてが　ちゅうしを　えらんだので"
	next "den Tausch abge-"		; "こうかんを　ちゅうし　します"
	cont "brochen."
	db   "@"
